...
class NativeCloudEnvironmentRepositoryFactory
        implements EnvironmentRepositoryFactory<NativeCloudEnvironmentRepository, NativeEnvironmentProperties>
{
    ...
    NativeCloudEnvironmentRepositoryFactory(CloudMapper cloudMapper, ConfigurableEnvironment environment,
    ...
    public NativeCloudEnvironmentRepository build(NativeEnvironmentProperties environmentProperties)
    {
        ...
        return new NativeCloudEnvironmentRepository(this.cloudMapper, this.environment, environmentProperties);
    }
}