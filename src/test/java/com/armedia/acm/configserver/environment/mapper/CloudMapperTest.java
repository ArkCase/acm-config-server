...
public class CloudMapperTest
{
    ...
    {
        CloudMapperProperties properties = new CloudMapperProperties(null, null, null, true, null, CloudMapperTest.NAMESPACE);
    ...
    {
        CloudMapperProperties properties = new CloudMapperProperties(null, null, null, true, true, CloudMapperTest.NAMESPACE);
        CloudMapper cloudMapper = new CloudMapper(properties, CloudMapperTest.CLIENT);
        cloudMapper.postConstruct();
